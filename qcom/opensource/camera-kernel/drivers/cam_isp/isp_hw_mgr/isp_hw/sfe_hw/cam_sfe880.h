...
#define _CAM_SFE880_H_
#include "cam_sfe_core.h"
#include "cam_sfe_bus.h"
#include "cam_sfe_bus_rd.h"
#include "cam_sfe_bus_wr.h"

static struct cam_sfe_top_module_desc sfe_880_mod_desc[] = {
	{
		.id = 0,
		.desc = "CRC_IRC",
	},
...
static struct cam_sfe_wr_client_desc sfe_880_wr_client_desc[] = {
	{
		.wm_id = 0,
		.desc = "REMOSAIC",
	},
...
static struct cam_sfe_mode sfe_880_mode[] = {
	{
		.value = 0x0,
...
static struct cam_sfe_top_err_irq_desc sfe_880_top_irq_err_desc[] = {
	{
		.bitmask = BIT(14),
...
static struct cam_sfe_top_debug_info
	sfe880_clc_dbg_module_info[CAM_SFE_TOP_DBG_REG_MAX][8] = {
	...
	SFE_DBG_INFO_ARRAY_4bit(
		"xcfa_demux_csid",
		"sfe_hdr_stats_throttle",
		"fcg_stats_ch2",
		"fcg_stats_ch1",
		"fcg_ch2",
		"fcg_ch1",
		"crop_rnd_clamp_hdr_stats",
		"stats_rs_ch0_throttler"
	),
	SFE_DBG_INFO_ARRAY_4bit(
		"stats_bhist_ch0_throttler",
		"stats_bg_ch0_throttler",
		"stats_rs_ch1_throttler",
		"stats_bhist_ch1_throttler",
		"stats_bg_ch1_throttler",
		"stats_rs_ch2_throttler",
		"stats_bhist_ch2_throttler",
		"stats_bg_ch2_throttler"
	),
	SFE_DBG_INFO_ARRAY_4bit(
		"sfe_rdi4",
		"sfe_rdi3",
	...
	SFE_DBG_INFO_ARRAY_4bit(
		...
		"sfe_op_throttler",
		"sfe_pp_zsl",
		"ccif_sample_width_conv_hdr_remo",
		"ccif_converter_ch2",
		"ccif_converter_ch1",
		"ccif_converter_ch0",
		"fetch2"
...
static struct cam_sfe_top_common_reg_offset  sfe880_top_commong_reg  = {
...
static struct cam_sfe_path_common_reg_data sfe_880_pix_reg_data = {
	.sof_irq_mask                  = 0x4,
	.eof_irq_mask                  = 0x8,
	.subscribe_irq_mask            = 0xC,
};

static struct cam_sfe_path_common_reg_data sfe_880_rdi0_reg_data = {
	.sof_irq_mask                  = 0x10,
	.eof_irq_mask                  = 0x20,
	.subscribe_irq_mask            = 0x30,
};

static struct cam_sfe_path_common_reg_data sfe_880_rdi1_reg_data = {
	.sof_irq_mask                  = 0x40,
	.eof_irq_mask                  = 0x80,
	.subscribe_irq_mask            = 0xC0,
};

static struct cam_sfe_path_common_reg_data sfe_880_rdi2_reg_data = {
	.sof_irq_mask                  = 0x100,
	.eof_irq_mask                  = 0x200,
	.subscribe_irq_mask            = 0x300,
};

static struct cam_sfe_path_common_reg_data sfe_880_rdi3_reg_data = {
	.sof_irq_mask                  = 0x400,
	.eof_irq_mask                  = 0x800,
	.subscribe_irq_mask            = 0xC00,
};

static struct cam_sfe_path_common_reg_data sfe_880_rdi4_reg_data = {
	.sof_irq_mask                  = 0x1000,
	.eof_irq_mask                  = 0x2000,
	.subscribe_irq_mask            = 0x3000,
};

static struct cam_sfe_top_hw_info sfe880_top_hw_info = {
	.common_reg = &sfe880_top_commong_reg,
...
static struct cam_irq_register_set sfe880_bus_rd_irq_reg[1] = {
	{
...
static struct cam_sfe_bus_rd_hw_info sfe880_bus_rd_hw_info = {
	.common_reg = {
		...
		.cons_violation_status        = 0x00000430,
		.ccif_violation_status        = 0x00000434,
		.irq_reg_info = {
			.num_registers = 1,
			.irq_reg_set = sfe880_bus_rd_irq_reg,
...
static struct cam_sfe_bus_wr_hw_info sfe880_bus_wr_hw_info = {
	.common_reg = {
		...
		.test_bus_ctrl                    = 0x00000994,
		.top_irq_mask_0                   = 0x00000020,
		.qos_eos_cfg                      = 0x00000990,
		.irq_reg_info = {
			.num_registers = 1,
	...
	.bus_client_reg = {
		/* BUS Client 0 REMOSAIC */
		{
			...
			.addr_cfg                 = 0x00000A70,
			.addr_status_0            = 0x00000A78,
			.addr_status_1            = 0x00000A7C,
			.addr_status_2            = 0x00000A80,
			.addr_status_3            = 0x00000A84,
			.debug_status_cfg         = 0x00000A88,
			.debug_status_0           = 0x00000A8C,
			.debug_status_1           = 0x00000A90,
		...
		/* BUS Client 1 IR OUT */
		{
			...
			.addr_cfg                 = 0x00000B70,
			.addr_status_0            = 0x00000B78,
			.addr_status_1            = 0x00000B7C,
			.addr_status_2            = 0x00000B80,
			.addr_status_3            = 0x00000B84,
			.debug_status_cfg         = 0x00000B88,
			.debug_status_0           = 0x00000B8C,
			.debug_status_1           = 0x00000B90,
		...
		/* BUS Client 2 STATS_BE_0 */
		{
			...
			.addr_cfg                 = 0x00000C70,
			.addr_status_0            = 0x00000C78,
			.addr_status_1            = 0x00000C7C,
			.addr_status_2            = 0x00000C80,
			.addr_status_3            = 0x00000C84,
			.debug_status_cfg         = 0x00000C88,
			.debug_status_0           = 0x00000C8C,
			.debug_status_1           = 0x00000C90,
		...
		/* BUS Client 3 STATS_BHIST_0 */
		{
			...
			.addr_cfg                 = 0x00000D70,
			.addr_status_0            = 0x00000D78,
			.addr_status_1            = 0x00000D7C,
			.addr_status_2            = 0x00000D80,
			.addr_status_3            = 0x00000D84,
			.debug_status_cfg         = 0x00000D88,
			.debug_status_0           = 0x00000D8C,
			.debug_status_1           = 0x00000D90,
		...
		/* BUS Client 16 HDR_STATS */
		{
			...
			.comp_group               = CAM_SFE_BUS_WR_COMP_GRP_10,
		},
	},
	.num_out = 17,
	.sfe_out_hw_info = {
		...
		{
			.sfe_out_type = CAM_SFE_BUS_SFE_OUT_HDR_STATS,
			.max_width    = 9312,
			.max_height   = 6772,
			.source_group = CAM_SFE_BUS_WR_SRC_GRP_0,
			.mid[0]       = 50,
...
static struct cam_irq_controller_reg_info sfe880_top_irq_reg_info = {
	.num_registers = 1,
	.irq_reg_set = sfe880_top_irq_reg_set,
...
struct cam_sfe_hw_info cam_sfe880_hw_info = {
	...
	.top_hw_info                   = &sfe880_top_hw_info,
};

#endif /* _CAM_SFE880_H_ */
